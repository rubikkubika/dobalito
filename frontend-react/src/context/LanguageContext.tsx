...
const translations = {
  ru: {
    ...
    'phone.phone_required': 'Номер телефона обязателен',
    'phone.phone_invalid': 'Неверный формат номера телефона',
    'phone.code_required': 'Код верификации обязателен',
    'phone.code_invalid': 'Неверный код верификации',
    'phone.code_sent': 'Код отправлен на номер',
  ...
  en: {
    ...
    'phone.phone_required': 'Phone number is required',
    'phone.phone_invalid': 'Invalid phone number format',
    'phone.code_required': 'Verification code is required',
    'phone.code_invalid': 'Invalid verification code',
    'phone.code_sent': 'Code sent to number',
  ...
  id: {
    ...
    'phone.subtitle': 'Masukkan nomor telepon untuk menerima kode verifikasi',
    'phone.phone': 'Nomor telepon',
    'phone.code': 'Kode verifikasi',
    'phone.name': 'Nama (opsional)',
    'phone.send_code': 'Kirim kode',
    'phone.verify_code': 'Verifikasi kode',
    'phone.resend_code': 'Kirim ulang kode',
    'phone.phone_required': 'Nomor telepon diperlukan',
    'phone.phone_invalid': 'Format nomor telepon tidak valid',
    'phone.code_required': 'Kode verifikasi diperlukan',
    'phone.code_invalid': 'Kode verifikasi tidak valid',
    'phone.code_sent': 'Kode dikirim ke nomor',
    'phone.code_expires': 'Kode berlaku selama 10 menit',
    'phone.success': 'Autentikasi telepon berhasil!',
